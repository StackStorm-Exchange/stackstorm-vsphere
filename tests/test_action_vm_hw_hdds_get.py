...
from vm_hw_hdds_get import VMGetHDDs
...
class VMGetHDDsTestCase(VsphereBaseActionTestCase):
    __test__ = True
    action_cls = VMGetHDDs

    def setUp(self):
        super(VMGetHDDsTestCase, self).setUp()
    ...
    @mock.patch("vm_hw_hdds_get.json")
    ...
    def test_run(self, mock_inventory, mock_check_inputs, mock_json):
        ...
        test_disk1 = vim.vm.device.VirtualDisk()
        test_disk2 = vim.vm.device.VirtualDisk()
        device = [test_disk2, test_disk1]
